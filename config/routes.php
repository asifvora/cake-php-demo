...
Router::scope('/', function (RouteBuilder $routes){
     ...
     * Load Site 
     */
    $routes->connect('/', ['controller'=>'Dashbords', 'action'=>'index']);

    /*
     * Dasshbord routes
     */
    $routes->connect('/dashbords', ['controller'=>'Dashbords', 'action'=>'index']);
    ...
    $routes->connect('/departments/view/:id', ['controller'=>'Departments', 'action'=>'view'], ['id'=>'\d+', 'pass'=>['id']]);


    /*
     * Designations routes
     */
    $routes->connect('/designations', ['controller'=>'Designations', 'action'=>'index']);
    $routes->connect('/designations/add', ['controller'=>'Designations', 'action'=>'add']);
    $routes->connect('/designations/edit/:id', ['controller'=>'Designations', 'action'=>'edit'], ['id'=>'\d+', 'pass'=>['id']]);
    $routes->connect('/designations/view/:id', ['controller'=>'Designations', 'action'=>'view'], ['id'=>'\d+', 'pass'=>['id']]);
    ...
    $routes->connect('/users/view/:id', ['controller'=>'Users', 'action'=>'view'], ['id'=>'\d+', 'pass'=>['id']]);
